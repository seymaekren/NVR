function [oldNVR_SCORE, assignmentAccuracy, assignments, NVR_SCORE]= NVR_withCH(peaks,NH_RDCS, CH_RDCS,HDEXCHANGE, peakIDs, NOES, VECTORS, VECTORS_CH,TYPES, ...
	     RESNUMS,SSTRUCT, HBOND, ALLDISTS, IALLDISTS, SHIFTS_Filename, SHIFTX_Filename, truncateProbabilities)
...
%addpath('/home/home4/apaydin/Mist/NVR/General');
...
[CP] = NVR_CS2PROB(ASSIGNTABLE,HSHIFTS,NSHIFTS,TYPES,SSTRUCT,NOES, ...
		   ALLDISTS,NTH,ROWIN,COLIN, truncateProbabilities);SXCP=CP;SSCP = CP;RP1 = CP;RP2 = CP;
%fprintf(1, 'check out CP. type return to cont.\n');
%keyboard
...
%fprintf(1, 'check out SXCP. type return to cont.\n');
%keyboard
...
[SSCP] = NVR_SHIFTS2PROB(ASSIGNTABLE,HSHIFTS,NSHIFTS,TYPES,SSTRUCT, ...
			 NOES,ALLDISTS,NTH,ROWIN,COLIN, SHIFTS_Filename, SHIFTX_Filename,truncateProbabilities);
%fprintf(1, 'check out SSCP. type return to cont.\n');
%keyboard
...
while(sum(sum(MASTER))<8)
   ...
   for(i=[.3 .3 .3 .3 .25 .25 .25 .25 .2 .2 .2 .2 .1 .1 .1 .1])
     [MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN]= ...
	  combine(SXCP.*CP,SSCP,MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN,NOES,ALLDISTS,NTH,S1,RDC1,RDC2,VECTORS,VECTORS_CH, i);
      [MASTER,ASSIGNTABLE]=updateMASTER(MASTER,ASSIGNTABLE,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
      [ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN]=reduceAll(ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
      [ASSIGNTABLE] = lockdown(MASTER,ASSIGNTABLE,NOES,ALLDISTS, NTH,ROWIN,COLIN);
      [MASTER,ASSIGNTABLE]=updateMASTER(MASTER,ASSIGNTABLE,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
...
for(i=1:20)
  [MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN]= ...
      combine(SXCP.*CP,SSCP,MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN,NOES,ALLDISTS,NTH,S1,RDC1,RDC2,VECTORS,VECTORS_CH, .9);
   [MASTER,ASSIGNTABLE]=updateMASTER(MASTER,ASSIGNTABLE,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
   [ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN]=reduceAll(ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
   [ASSIGNTABLE] = lockdown(MASTER,ASSIGNTABLE,NOES,ALLDISTS, NTH,ROWIN,COLIN);
   [MASTER,ASSIGNTABLE]=updateMASTER(MASTER,ASSIGNTABLE,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
...
for(q=[.9999,.999,.99,.9])
  [MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN]= ...
       combine(RP1,RP2,MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN,NOES,ALLDISTS,NTH,S1,RDC1,RDC2,VECTORS,VECTORS_CH, q);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
   [MASTER,ASSIGNTABLE]=updateMASTER(MASTER,ASSIGNTABLE,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
   [ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN]=reduceAll(ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
   [ASSIGNTABLE] = lockdown(MASTER,ASSIGNTABLE,NOES,ALLDISTS, NTH,ROWIN,COLIN);
   [MASTER,ASSIGNTABLE]=updateMASTER(MASTER,ASSIGNTABLE,ROWIN,COLIN);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
...
for(q=1:size(MASTER,1))
  ...
  if(sum(sum(MASTER))==size(MASTER,1))
   ...
   for(qq=[1,.8,1,.8,1,.8,1,.8])
      mx = max(max(RP1.*RP2));
      [MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN]= ...
	  combine(RP1,RP2,MASTER,ASSIGNTABLE,CP,SXCP,SSCP,RP1,RP2,ROWIN,COLIN,NOES,ALLDISTS,NTH,S1,RDC1,RDC2,VECTORS,VECTORS_CH, qq*mx);[ROWIN,COLIN]=sanitycheck(MASTER,ROWIN,COLIN);
...
RP1_A = NVR_RDC2PROB(ASSIGNTABLE,RDC1,VECTORS,S1,ROWIN,COLIN)+minval;RP1_A =ren(RP1_A);
RP2_A = NVR_RDC2PROB_CH(ASSIGNTABLE,RDC2,VECTORS_CH,S1,ROWIN,COLIN)+minval;RP2_A =ren(RP2_A);

HDE_A = NVR_HD2PROB(ASSIGNTABLE ,HDEXCHANGE,HBOND, truncateProbabilities)+minval;HDE_A=ren(HDE_A);
CP_A = NVR_CS2PROB(ASSIGNTABLE ,HSHIFTS,NSHIFTS,TYPES,SSTRUCT,NOES, ...
		   ALLDISTS,NTH,ROWIN,COLIN, truncateProbabilities)+minval;CP_A =ren(CP_A);
SXCP_A = NVR_SHIFTX2PROB(ASSIGNTABLE,HSHIFTS,NSHIFTS,TYPES,SSTRUCT, ...
			NOES,ALLDISTS,NTH,ROWIN,COLIN, SHIFTX_Filename, ...
			 truncateProbabilities)+minval;SXCP_A =ren(SXCP_A);
SSCP_A = NVR_SHIFTS2PROB(ASSIGNTABLE,HSHIFTS,NSHIFTS,TYPES,SSTRUCT, ...
			NOES,ALLDISTS,NTH,ROWIN,COLIN, SHIFTS_Filename, ...
			SHIFTX_Filename, truncateProbabilities)+minval;SSCP_A = ...
	 ren(SSCP_A);
