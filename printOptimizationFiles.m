function printOptimizationFiles (CP, SXCP, SSCP, TP, HDE, refineWithRDCs, ...
    ...
    NTH, useBayesianMatrix, inputModeIndex, inputModelIndex)

VERY_LARGE_NUMBER     = 1E9;
combinedScoringMatrix = zeros(size(CP));

filename = sprintf('OutputFiles/1EF1/combinedScoringMatrix.%d.model%d.txt',inputModeIndex, inputModelIndex);
