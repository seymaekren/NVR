function printOptimizationFiles_4RDC_Matrices (CP, SXCP, SSCP, TP, HDE,  ...
					       RP1, RP2, RP3, RP4, NOES, ALLDISTS, COLIN, ...
					       NTH)

VERY_LARGE_NUMBER     = 1E9;
combinedScoringMatrix = zeros(size(CP));
fid                   = fopen('combinedScoringMatrix_4RDC_Matrices.txt','w');
fprintf(1, 'printing to combinedScoringMatrix_4RDC_Matrices.txt\n');
...
for rowIndex = 1:size(combinedScoringMatrix,1)
  ...
  checkEntry(RP4(rowIndex,rowIndex),  rowIndex, 'RP4');
