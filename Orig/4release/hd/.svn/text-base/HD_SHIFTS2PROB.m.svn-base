function [M] = HD_SHIFTS2PROB(TABLE,H,N,TYPES,SSTRUCT,NOES,ALLDISTS,NTH,ROWIN,COLIN);
...
FILTERS=load('../../CHEMSHIFTSTATS/SHIFTSFILTERS');FILTERS=FILTERS.FILTERS;

[rn TY SS ha hn nf cb ca co]= textread('SHIFTX.m','%f %s %s %f %f %f %f %f %f \n');
[rn hn nf]= textread('SHIFTS.m','%f %f %f \n');
