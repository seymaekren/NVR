function [oldNVR_SCORE, assignmentAccuracy, assignments, NVR_SCORE]= NVR(peaks,rdcs,HDEXCHANGE, peakIDs, NOES, VECTORS,TYPES, ...
...
fprintf(1, 'set NTH to something else if you want to, here.\n');
keyboard
...
RP2_A = NVR_RDC2PROB(ASSIGNTABLE,RDC2,VECTORS,S2,ROWIN,COLIN)+minval;RP2_A =ren(RP2_A);
...
SXCP_A = NVR_SHIFTX2PROB(ASSIGNTABLE,HSHIFTS,NSHIFTS,TYPES,SSTRUCT, ...
			NOES,ALLDISTS,NTH,ROWIN,COLIN, SHIFTX_Filename,truncateProbabilities)+minval;SXCP_A =ren(SXCP_A);
