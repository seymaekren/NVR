function [ASSIGNTABLE,voter,numVoters, unassignedPeakIndicesCorrespondingToAssigntable,unassignedResidueIndicesCorrespondingToAssigntable,SSCP,SXCP,CP,TP,HDE] ...
    = removeAssignedPeaksAndResidues(MASTER,ASSIGNTABLE,voter,numVoters,unassignedPeakIndicesCorrespondingToAssigntable,unassignedResidueIndicesCorrespondingToAssigntable,SSCP,SXCP,CP,TP,HDE);
...
TP   = TP  (relPeakIndices, relResidueIndices);
HDE  = HDE (relPeakIndices, relResidueIndices);
