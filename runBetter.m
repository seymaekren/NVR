...
if (useOrigData)
    ...
    %CHANGED
    SHIFTX_Filename   = sprintf('InputFiles/SHIFTX/MySHIFTX.%d.model%d.1UBQ',inputModeIndex, inputModelIndex);
    SHIFTS_Filename   = sprintf('InputFiles/SHIFTS/MySHIFTS.%d.model%d.1UBQ',inputModeIndex, inputModelIndex);
    ...
    elseif ((refineWithRDCs == 1) && (b_runningMBP == 1)) 
	 ...
	 [VECTORS, TYPES, RESNUMS,SSTRUCT, HBOND, ALLDISTS, IALLDISTS, ignoredHSQCDATA] = loaddata_CA('InputFiles/myinput.m');
...
if ((~runOriginalNVR) && (~runOriginalHD)) 
    betterHD2(peaks, rdcs, HDEXCHANGE, NH_RDCS, CH_RDCS, ...
        ...
        b_printOptimizationFiles, b_printIndividualScores, useFourRDCsPerResidue, ...
        b_runningMBP, b_runningEIN, b_running1FQB,b_runningPoln, ...
        b_printIndividualScoringMatrix, inputModeIndex, inputModelIndex); %changed
