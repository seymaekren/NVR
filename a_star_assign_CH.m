function [foundMASTERs, finalScores, assignmentAccuracies, totalNumAssignments] ...
    = a_star_assign_CH(MASTER, voter, numVoters, ASSIGNTABLE, peakIndices, ...
		    residueIndices, NOES, ALLDISTS, IALLDISTS, NTH, ...
		    peakIDs, RESNUMS, NH_RDCS, CH_RDCS, VECTORS_NH, VECTORS_CH, MB_ShiftScore, ...
...
MAXNUMNODES           = 1000;
MAXNUMSOLUTIONS       = 100;
MAX_FRAGMENT_SIZE     = 3; %number of amino acids such that if so
...
%    keyboard
	...
	expand(ASSIGNTABLES, MASTERS, voters, numVoterss, ...
	       ...
	       residueIndices, scoreSoFar, NOES, IALLDISTS, ALLDISTS, NTH, NH_RDCS, CH_RDCS, VECTORS_NH, VECTORS_CH,MB_ShiftScore, ...
...
function [ASSIGNTABLES,MASTERS, voters, numVoterss, peakIndicess, residueIndicess, scoreSoFars, h_values, next, numNodes]  =  expand (ASSIGNTABLES, MASTERS, voters, numVoterss, ...
						  ...
						  residueIndices, ...
						  scoreSoFar, NOES, ...
						  IALLDISTS, ALLDISTS, NTH, NH_RDCS, CH_RDCS, VECTORS_NH, VECTORS_CH,MB_ShiftScore, ...
						  MB_RDC_Score, ...
						  numCS, numRDC, ...
						  HSQCDATA,...
...
for candidateIndex = 1:numCandidates
  ...
  [impossibleToAssign, newMaster, newAssigntable, newUnassignedPeakIndices, newUnassignedResidueIndices, newScoreSoFar, newVoter, newNumVoters] = ...
      noePruneAndDoMoreAssignments_CH(newAssigntable, MASTER, ...
				   peakIndices, ...
				   residueIndices, ...
				   scoreSoFar,...
				   voter, numVoters,...
				   ...
				   CH_RDCS, VECTORS_NH, VECTORS_CH,MB_ShiftScore, ...
				   MB_RDC_Score, numCS, numRDC, ...
