function [ROWIN, COLIN, ASSIGNTABLE, MASTER, HDE, CP, SXCP, SSCP, NTH, RP1, RP2,differenceMatrixH_SHIFTX, differenceMatrixN_SHIFTX, differenceMatrixH_SHIFTS, differenceMatrixN_SHIFTS,alphaHelixMatrix,betaStrandMatrix,coilMatrix] = initialize_withCH(peaks,HDEXCHANGE, peakIDs, NOES, VECTORS_NH, VECTORS_CH,TYPES, RESNUMS,SSTRUCT, ...
						  HBOND, ALLDISTS, ...
						  IALLDISTS, ...
						  SHIFTS_Filename, ...
						  SHIFTX_Filename, ...
...
[SXCP,differenceMatrixH_SHIFTX, differenceMatrixN_SHIFTX]      = NVR_SHIFTX2PROB(ASSIGNTABLE,HSHIFTS,NSHIFTS,TYPES,SSTRUCT, ...
...
[SSCP,differenceMatrixH_SHIFTS, differenceMatrixN_SHIFTS,alphaHelixMatrix,betaStrandMatrix,coilMatrix] = NVR_SHIFTS2PROB(ASSIGNTABLE,HSHIFTS,NSHIFTS,TYPES,SSTRUCT, ...
