function [M] = NVR_SHIFTS2PROB(TABLE,H,N,TYPES,SSTRUCT,NOES,ALLDISTS, ...
...
FILTERS=load('~njp/code/JBN-Submission-Snapshot-06-15-07/NVR/CHEMSHIFTSTATS/SHIFTSFILTERS');FILTERS=FILTERS.FILTERS;
