function [assignmentAccuracy,assignments] = ...
    computeAssignmentAccuracy(peakIDs, RESNUMS, MASTER, printAssignmentAccuracy)

a = load('InputFiles/answerkey.m');
assignments=0;
correct=0;
incorr=0;
numResidues = size(MASTER,2);
