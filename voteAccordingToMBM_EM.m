function  [relCandidatePeakIndices, relCandidateResidueIndices, scores, numCandidates] =  voteAccordingToMBM_EM(voter, numVoters, ASSIGNTABLE,peakIndices,residueIndices);
...
%while ((numCandidates < MAX_NUMCANDIDATES) &
%(~stopGeneratingCandidates))
while (~stopGeneratingCandidates)
  ...
  fprintf(1, 'assignment of %d to %d has %d votes and %f probability.\n',peakIndices(bestRelPeakIndex),residueIndices(bestRelResidueIndex),maxVotes, scores(numCandidates));
